...
for xx,yy in zip(x,y):
    h=Circle((xx,yy),20,facecolor='white',edgecolor='black', zorder=2)
    gca().add_artist(h)
# #plot(x,y,'o',color='white',markeredgecolor='black',markersize=60, clip_on=False)
for xx,yy,L in zip(x,y,labels):
    text(xx,yy,L,ha='center',va='center',color='black',fontfamily='monospace',size=6)
xl=gca().get_xlim()
yl=gca().get_ylim()
