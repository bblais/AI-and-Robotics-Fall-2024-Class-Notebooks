...
image=imread(f"images/Plain2.jpg")
imshow(image)
...
h, w = image.shape[:2]
black_and_white=((gray>threshold)*255).astype(np.uint8)
...
training_squares_folder='images/2024-11-26 - training squares Plain2'
